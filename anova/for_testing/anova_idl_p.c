...
typedef struct _anova_idl_MIDL_TYPE_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ TYPE_FORMAT_STRING_SIZE ];
    } anova_idl_MIDL_TYPE_FORMAT_STRING;

typedef struct _anova_idl_MIDL_PROC_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ PROC_FORMAT_STRING_SIZE ];
    } anova_idl_MIDL_PROC_FORMAT_STRING;

typedef struct _anova_idl_MIDL_EXPR_FORMAT_STRING
    {
    long          Pad;
    unsigned char  Format[ EXPR_FORMAT_STRING_SIZE ];
    } anova_idl_MIDL_EXPR_FORMAT_STRING;
...
extern const anova_idl_MIDL_TYPE_FORMAT_STRING anova_idl__MIDL_TypeFormatString;
extern const anova_idl_MIDL_PROC_FORMAT_STRING anova_idl__MIDL_ProcFormatString;
extern const anova_idl_MIDL_EXPR_FORMAT_STRING anova_idl__MIDL_ExprFormatString;
...
static const anova_idl_MIDL_PROC_FORMAT_STRING anova_idl__MIDL_ProcFormatString =
    {
        0,
        {
...
/* 150 */	NdrFcShort( 0x400 ),	/* Type Offset=1024 */
...
static const anova_idl_MIDL_TYPE_FORMAT_STRING anova_idl__MIDL_TypeFormatString =
    {
        0,
        {
			NdrFcShort( 0x0 ),	/* 0 */
...
/* Object interface: IClass1, ver. 0.0,
   GUID={0xC7FDE8D1,0x7C27,0x4593,{0x85,0x4E,0x81,0x8C,0xA7,0xB9,0x83,0x58}} */
...
static const MIDL_STUBLESS_PROXY_INFO IClass1_ProxyInfo =
    {
    &Object_StubDesc,
    anova_idl__MIDL_ProcFormatString.Format,
...
static const MIDL_STUB_DESC Object_StubDesc = 
    ...
    0,
    0,
    anova_idl__MIDL_TypeFormatString.Format,
...
const CInterfaceProxyVtbl * const _anova_idl_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_IClass1ProxyVtbl,
    0
};

const CInterfaceStubVtbl * const _anova_idl_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_IClass1StubVtbl,
    0
};

PCInterfaceName const _anova_idl_InterfaceNamesList[] = 
{
    "IClass1",
    0
};

const IID *  const _anova_idl_BaseIIDList[] = 
{
    &IID_IDispatch,
    0
};
...
#define _anova_idl_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _anova_idl, pIID, n)

int __stdcall _anova_idl_IID_Lookup( const IID * pIID, int * pIndex )
{
    
    if(!_anova_idl_CHECK_IID(0))
        {
        *pIndex = 0;
        return 1;
        }
...
const ExtendedProxyFileInfo anova_idl_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _anova_idl_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _anova_idl_StubVtblList,
    (const PCInterfaceName * ) & _anova_idl_InterfaceNamesList,
    (const IID ** ) & _anova_idl_BaseIIDList,
    & _anova_idl_IID_Lookup, 
    1,
    2,
