...
-anova_1_0.dll (output from mcc)
-anova.bas (VBA module file created by mcc)
-anova.xla (Excel AddIn file created by mcc)
-MCRInstaller.exe
   -if end users are unable to download the MATLAB Runtime using the above  
    link, include it when building your component in the Deployment Tool
-This readme file

NOTE: Verify anova_1_0.dll is registered on the target machine. If you have trouble 
