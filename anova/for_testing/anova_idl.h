...
#ifndef __anova_idl_h__
#define __anova_idl_h__
...
EXTERN_C const IID IID_IClass1;
    ...
    MIDL_INTERFACE("C7FDE8D1-7C27-4593-854E-818CA7B98358")
    ...
    public:
        ...
        virtual /* [helpstring][id] */ HRESULT STDMETHODCALLTYPE anova( 
            /* [in] */ VARIANT x) = 0;
    ...
    typedef struct IClass1Vtbl
    {
        ...
        /* [helpstring][id] */ HRESULT ( STDMETHODCALLTYPE *anova )( 
            IClass1 * This,
            /* [in] */ VARIANT x);
...
#define IClass1_anova(This,x)	\
    ( (This)->lpVtbl -> anova(This,x) ) 
...
#ifndef __anova_LIBRARY_DEFINED__
#define __anova_LIBRARY_DEFINED__

/* library anova */
/* [helpstring][version][uuid] */ 


EXTERN_C const IID LIBID_anova;

EXTERN_C const CLSID CLSID_Class1;

#ifdef __cplusplus

class DECLSPEC_UUID("9CA3766D-E60D-4FAB-8DB1-03433CDE275E")
Class1;
#endif
#endif /* __anova_LIBRARY_DEFINED__ */
