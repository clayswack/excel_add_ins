...
{
  {
    ...
    Class1::GetClassObject, "Class1", "anova.Class1", "anova.Class1.1_0"
  },
  {
    NULL, NULL, NULL, NULL, "", "", ""
  }
...
{
  initialize_path();
  return g_pModule->InitMain(objectmap, &LIBID_anova, 1, 0, hInstance, dwReason, pv);
}
