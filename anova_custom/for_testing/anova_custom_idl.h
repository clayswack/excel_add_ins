...
#ifndef __anova_custom_idl_h__
#define __anova_custom_idl_h__
...
EXTERN_C const IID IID_IClass1;
    ...
    MIDL_INTERFACE("F8DE4D12-02A5-4539-A0E7-BA3F5C758EE1")
    ...
    public:
        ...
        virtual /* [helpstring][id] */ HRESULT STDMETHODCALLTYPE anova_custom( 
            /* [in] */ VARIANT x,
            /* [in] */ VARIANT y) = 0;
    ...
    typedef struct IClass1Vtbl
    {
        ...
        /* [helpstring][id] */ HRESULT ( STDMETHODCALLTYPE *anova_custom )( 
            IClass1 * This,
            /* [in] */ VARIANT x,
            /* [in] */ VARIANT y);
...
#define IClass1_anova_custom(This,x,y)	\
    ( (This)->lpVtbl -> anova_custom(This,x,y) ) 
...
#ifndef __anova_custom_LIBRARY_DEFINED__
#define __anova_custom_LIBRARY_DEFINED__

/* library anova_custom */
/* [helpstring][version][uuid] */ 


EXTERN_C const IID LIBID_anova_custom;

EXTERN_C const CLSID CLSID_Class1;

#ifdef __cplusplus

class DECLSPEC_UUID("BACC926C-165D-4973-9C33-38629A8E52E2")
Class1;
#endif
#endif /* __anova_custom_LIBRARY_DEFINED__ */
