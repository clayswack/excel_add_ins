...
{
  {
    ...
    Class1::GetClassObject, "Class1", "anova_custom.Class1", "anova_custom.Class1.1_0"
  },
  {
    NULL, NULL, NULL, NULL, "", "", ""
  }
...
{
  initialize_path();
  return g_pModule->InitMain(objectmap, &LIBID_anova_custom, 1, 0, hInstance, dwReason, 
                             pv);
}
