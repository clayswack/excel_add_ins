...
{
  {
    ...
    Class1::GetClassObject, "Class1", "signalint.Class1", "signalint.Class1.1_0"
  },
  {
    NULL, NULL, NULL, NULL, "", "", ""
  }
...
{
  initialize_path();
  return g_pModule->InitMain(objectmap, &LIBID_signalint, 1, 0, hInstance, dwReason, pv);
}
