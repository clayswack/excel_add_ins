...
typedef struct _signalint_idl_MIDL_TYPE_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ TYPE_FORMAT_STRING_SIZE ];
    } signalint_idl_MIDL_TYPE_FORMAT_STRING;

typedef struct _signalint_idl_MIDL_PROC_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ PROC_FORMAT_STRING_SIZE ];
    } signalint_idl_MIDL_PROC_FORMAT_STRING;

typedef struct _signalint_idl_MIDL_EXPR_FORMAT_STRING
    {
    long          Pad;
    unsigned char  Format[ EXPR_FORMAT_STRING_SIZE ];
    } signalint_idl_MIDL_EXPR_FORMAT_STRING;
...
extern const signalint_idl_MIDL_TYPE_FORMAT_STRING signalint_idl__MIDL_TypeFormatString;
extern const signalint_idl_MIDL_PROC_FORMAT_STRING signalint_idl__MIDL_ProcFormatString;
extern const signalint_idl_MIDL_EXPR_FORMAT_STRING signalint_idl__MIDL_ExprFormatString;
...
static const signalint_idl_MIDL_PROC_FORMAT_STRING signalint_idl__MIDL_ProcFormatString =
    {
        0,
        {
...
static const signalint_idl_MIDL_TYPE_FORMAT_STRING signalint_idl__MIDL_TypeFormatString =
    {
        0,
        {
			NdrFcShort( 0x0 ),	/* 0 */
...
/* Object interface: IClass1, ver. 0.0,
   GUID={0x871780C9,0x4572,0x4D93,{0xBF,0x88,0x33,0xA9,0xAC,0x95,0x60,0xEF}} */
...
static const MIDL_STUBLESS_PROXY_INFO IClass1_ProxyInfo =
    {
    &Object_StubDesc,
    signalint_idl__MIDL_ProcFormatString.Format,
...
CINTERFACE_PROXY_VTABLE(11) _IClass1ProxyVtbl = 
{
    ...
    (void *) (INT_PTR) -1 /* IClass1::signalint */ ,
...
static const MIDL_STUB_DESC Object_StubDesc = 
    ...
    0,
    0,
    signalint_idl__MIDL_TypeFormatString.Format,
...
const CInterfaceProxyVtbl * const _signalint_idl_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_IClass1ProxyVtbl,
    0
};

const CInterfaceStubVtbl * const _signalint_idl_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_IClass1StubVtbl,
    0
};

PCInterfaceName const _signalint_idl_InterfaceNamesList[] = 
{
    "IClass1",
    0
};

const IID *  const _signalint_idl_BaseIIDList[] = 
{
    &IID_IDispatch,
    0
};
...
#define _signalint_idl_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _signalint_idl, pIID, n)

int __stdcall _signalint_idl_IID_Lookup( const IID * pIID, int * pIndex )
{
    
    if(!_signalint_idl_CHECK_IID(0))
        {
        *pIndex = 0;
        return 1;
        }
...
const ExtendedProxyFileInfo signalint_idl_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _signalint_idl_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _signalint_idl_StubVtblList,
    (const PCInterfaceName * ) & _signalint_idl_InterfaceNamesList,
    (const IID ** ) & _signalint_idl_BaseIIDList,
    & _signalint_idl_IID_Lookup, 
    1,
    2,
