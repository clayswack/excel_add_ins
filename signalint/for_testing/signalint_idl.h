...
#ifndef __signalint_idl_h__
#define __signalint_idl_h__
...
EXTERN_C const IID IID_IClass1;
    ...
    MIDL_INTERFACE("871780C9-4572-4D93-BF88-33A9AC9560EF")
    ...
    public:
        ...
        virtual /* [helpstring][id] */ HRESULT STDMETHODCALLTYPE signalint( 
            /* [in] */ VARIANT x,
            /* [in] */ VARIANT y) = 0;
    ...
    typedef struct IClass1Vtbl
    {
        ...
        /* [helpstring][id] */ HRESULT ( STDMETHODCALLTYPE *signalint )( 
            IClass1 * This,
            /* [in] */ VARIANT x,
            /* [in] */ VARIANT y);
...
#define IClass1_signalint(This,x,y)	\
    ( (This)->lpVtbl -> signalint(This,x,y) ) 
...
#ifndef __signalint_LIBRARY_DEFINED__
#define __signalint_LIBRARY_DEFINED__

/* library signalint */
/* [helpstring][version][uuid] */ 


EXTERN_C const IID LIBID_signalint;

EXTERN_C const CLSID CLSID_Class1;

#ifdef __cplusplus

class DECLSPEC_UUID("12AAC7DE-AF78-4E7B-9991-C8B831553F9F")
Class1;
#endif
#endif /* __signalint_LIBRARY_DEFINED__ */
